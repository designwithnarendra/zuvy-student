      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div className="flex-1">
            <Badge
              className={`mb-2 pointer-events-none ${
                project.status === 'submitted'
                  ? 'bg-success-light text-success dark:text-foreground border-success/20'
                  : 'bg-muted-light text-muted-foreground dark:text-foreground border-muted-foreground/20'
              }`}
            >
            ...
            <p className="text-foreground mb-3 line-clamp-2 text-sm">{project.description}</p>
