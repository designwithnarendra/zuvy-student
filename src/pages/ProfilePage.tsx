...
import { SKILLS_BY_CATEGORY, COLLEGES, CAREER_ROLES, INDIAN_CITIES } from '@/lib/onboarding.mockData';
...
export const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    if (editingCard === 'work-experience') {
      setHasInternship(step3?.workExperiences && step3.workExperiences.length > 0);
    }
                ...
                {editingCard !== 'skills' ? (
                  ...
                  <>
                    ...
                    <div className="space-y-4">
                      {/* Display tags */}
                      {((step2.autoDetectedSkills && step2.autoDetectedSkills.length > 0) || skills.length > 0) && (
                        <div className="flex flex-wrap gap-2">
                          {step2.autoDetectedSkills?.map((skill) => (
