...
export function getStatusBadgeStyles(status: string): string {
  ...
  if (statusLower === 'not completed') {
    return "bg-muted-light text-muted-foreground dark:text-foreground border border-muted";
  }
  ...
  if (statusLower.includes('interrupted') ||
    ...
    return "bg-warning-light text-warning dark:text-foreground border border-warning";
  }
  ...
  if (statusLower.includes('submitted') ||
    ...
    return "bg-success-light text-success dark:text-foreground border border-success";
  }
